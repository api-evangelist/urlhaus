...
- **source:** [public-apis/public-apis](https://github.com/public-apis/public-apis) — category: Anti-Malware

## API
- **URLhaus** — [Documentation](https://urlhaus-api.abuse.ch/)

## Tags
Anti Malware, Public APIs
